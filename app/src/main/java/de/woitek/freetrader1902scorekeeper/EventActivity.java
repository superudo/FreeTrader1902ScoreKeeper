...
public class EventActivity extends Activity implements RadioGroup.OnCheckedChangeListener, Observer {
    ...
    private GameEventFight gameFight;
    ...
    private void switchAction(int selectedButtonIndex) {
        switch (selectedButtonIndex) {
            case 0: // Bandit
                gameFight.setEnemy(GameEventFight.Enemy.HIGHWAYMAN);
                findViewById(R.id.rgMultiplier).setVisibility(View.VISIBLE);
                switcher.setDisplayedChild(1);
                break;
            case 1: // Bear
                gameFight.setEnemy(GameEventFight.Enemy.BEAR);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameFight = new GameEventFight(gameData);
        ...
        StyledRadioGroup rgAction = (StyledRadioGroup) findViewById(R.id.rgAction);
    ...
    public void update(Observable observable, Object o) {
        ...
        if (gameFight.canFight()) { // Fight result
            ...
            if (gameFight.hasPlayerWon()) {
                ...
                if (gameFight.getFight() == GameEventFight.Fight.DEFENSE) {
                    a.append(R.id.lblRules, "You may now fight back or try to flee by drawing another event card.");
                } else { // OFFENSE
                    if (gameFight.getEnemy() == GameEventFight.Enemy.HIGHWAYMAN) {
                        a.append(R.id.lblRules,
