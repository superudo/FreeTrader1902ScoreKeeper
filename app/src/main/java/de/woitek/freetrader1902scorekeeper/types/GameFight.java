...
public class GameFight extends Observable implements GameEvent, Parcelable {
	...
	public void writeToParcel(Parcel dest, int flags) {
		dest.writeString(mEnemy.toString());
		dest.writeString(mFight.toString());
		dest.writeInt(mEnemyMight);
		dest.writeInt(mEnemyModifier);
		dest.writeInt(mPlayerModifier);
	}
